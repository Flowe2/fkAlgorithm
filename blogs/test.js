$(function () {
    ...
    function n(t, e) {
        if (!i) {
            if (d = t, o.text(m[d][0]), s.text("神马"), c.text("？"), a.addClass("shake"), k = 0, e) { var n = $(".tip").show(); setTimeout(function () { n.remove() }, 4000) }
        }
    }
    var i = 0,
        a = $(".title"),
        ...
        w = "human", b, C, E;
    m[1][1] = m[2][1],
        a.on("animationend webkitAnimationEnd", function (t) { $(this).removeClass("shake") }),
        r.on("animationend webkitAnimationEnd", function (t) { $(t.target).remove() }),
        l.click(function () {
            if (g.toggleClass("playing", !i),
                i) {
                i = 0, "monster" == w && x.text(u[t(u.length)]),
                    c.text("！"),
                ...
                i = 1, k++, 2 == k && e("我就知道你会换一个 ( ͡° ͜ʖ ͡°)"),
                    ...
                    30 == k && e("再换我可要报警了！( *・ω・)✄╰ひ╯"); var n = "human" == w ? m[d][1] : h; c.text("？"),
                        l.find("span").text("停"),
                        x.text(""),
                        function o() {
                            var e = t(n.length) - 1, i = n[e], a = t(1200),
                                c = t(1200),
                                l = t(37, 14); s.text(i); var m = $("<span class='temp'>" + i + "</span>").css({ top: a, left: c, color: "rgba(0,0,0," + t(7, 3) / 10 + ")", fontSize: l + "px" }).appendTo(r); b = setTimeout(o, 60)
                        }()
            }
        }),
        $("#toggle span").click(function () {
            $(this).hasClass("selected") || ($(this).addClass("selected").siblings().removeClass("selected"),
                ...
                k = 0, _hmt.push(["_trackEvent", "type", "toggle", w]))
        }),
        9 > p || p >= 23 ? n(0, 1) : 13 > p && n(1, 1),
        a.click(function () { n(d >= m.length - 1 ? 0 : d + 1) }),
